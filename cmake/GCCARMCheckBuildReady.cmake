...
set(CMAKE_C_FLAGS "\"-m${CODE_TYPE}\" \"-mcpu=${CPU_TYPE}\" -g -gdwarf-2 ${VENDOR_C_FLAGS} ${GCC_ARM_OPTIMIZATION_FLAGS} ${GCC_ARM_ASSERT_FLAGS}")
set(CMAKE_CXX_FLAGS "\"-m${CODE_TYPE}\" \"-mcpu=${CPU_TYPE}\" -g -gdwarf-2 ${VENDOR_CXX_FLAGS} ${GCC_ARM_OPTIMIZATION_FLAGS} ${GCC_ARM_ASSERT_FLAGS}")
